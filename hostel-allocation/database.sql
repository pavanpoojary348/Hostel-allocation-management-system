...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2026-04-10 05:41:57',NULL),('diagnostics.include_raw','OFF','2026-04-10 05:41:57',NULL),('ps_thread_trx_info.max_length','65535','2026-04-10 05:41:57',NULL),('statement_performance_analyzer.limit','100','2026-04-10 05:41:57',NULL),('statement_performance_analyzer.view',NULL,'2026-04-10 05:41:57',NULL),('statement_truncate_len','64','2026-04-10 05:41:57',NULL);
...
-- Dump completed on 2026-04-24  7:32:47
...
-- MySQL dump 10.13  Distrib 8.0.45, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: hostel_db
-- ------------------------------------------------------
-- Server version	8.0.45
...
INSERT INTO `allocations` VALUES (6,'2026-04-18','Confirmed',5,2),(9,'2026-04-20','Confirmed',12,4),(12,'2026-04-23','Confirmed',1,3),(13,'2026-04-23','Confirmed',11,1),(14,'2026-04-23','Confirmed',8,6),(15,'2026-04-23','Confirmed',12,1);
...
DROP TABLE IF EXISTS `hostel_block`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `hostel_block` WRITE;
/*!40000 ALTER TABLE `hostel_block` DISABLE KEYS */;
INSERT INTO `hostel_block` VALUES (1,'Block A','Male',20),(2,'Block B','Female',20);
/*!40000 ALTER TABLE `hostel_block` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `notifications` VALUES (1,11,'? Your room has been allocated! Check your dashboard for details.',1,'2026-04-18 02:23:50'),(2,12,'? Your room has been allocated! Check your dashboard for details.',1,'2026-04-20 23:56:21'),(3,14,'? Your room has been allocated! Check your dashboard for details.',0,'2026-04-23 05:27:09'),(4,16,'? Your room has been allocated! Check your dashboard for details.',1,'2026-04-23 05:32:12'),(5,1,'? Your room has been allocated! Check your dashboard for details.',0,'2026-04-23 09:37:22'),(6,11,'? Your room has been allocated! Check your dashboard for details.',1,'2026-04-23 09:37:41'),(7,8,'? Your room has been allocated! Check your dashboard for details.',0,'2026-04-23 09:38:00'),(8,12,'? Your room has been allocated! Check your dashboard for details.',0,'2026-04-23 09:39:44'),(9,17,'⏳ You have been added to the waitlist. We will notify you when a room is available.',0,'2026-04-23 09:54:56');
...
CREATE TABLE `preferences` (
  ...
  `pref_roommate_id` int DEFAULT NULL,
  `max_budget` decimal(8,2) DEFAULT NULL,
  `priority_level` int DEFAULT NULL,
  `student_id` int DEFAULT NULL,
  `preferred_block` varchar(50) DEFAULT NULL,
  `roommate_preference` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`pref_id`),
  UNIQUE KEY `student_id` (`student_id`),
  CONSTRAINT `preferences_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`)
...
INSERT INTO `preferences` VALUES (1,2,NULL,5000.00,NULL,11,'Block B','NNM24IS149'),(2,2,NULL,15000.00,NULL,12,'Block A','NNM24IS150'),(3,1,NULL,10000.00,NULL,15,'Block A','NNM24IS160'),(4,1,NULL,5000.00,NULL,16,'Block A','NNM24IS163'),(5,3,NULL,5000.00,NULL,17,'Block B','NNM24IS163');
...
CREATE TABLE `rooms` (
  ...
  `washroom` enum('Attached','Outside') DEFAULT 'Outside',
  PRIMARY KEY (`room_id`),
  KEY `block_id` (`block_id`),
  CONSTRAINT `rooms_ibfk_1` FOREIGN KEY (`block_id`) REFERENCES `hostel_block` (`block_id`)
...
INSERT INTO `rooms` VALUES (1,1,2,5000.00,'Occupied',1,'Double','Non-AC','Outside'),(2,1,2,5000.00,'Available',1,'Double','Non-AC','Outside'),(3,2,2,6000.00,'Occupied',2,'Double','AC','Attached'),(4,2,2,6000.00,'Available',2,'Double','AC','Attached'),(5,3,3,7000.00,'Available',1,'Triple','AC','Attached'),(6,2,2,5000.00,'Occupied',2,'Single','AC','Attached');
...
INSERT INTO `students` VALUES (1,'Pavan Poojary','Male',2,'ISE',8000.00,'4NM23IS001',NULL,NULL,'ISE',NULL,NULL),(2,'Rahul Shetty','Male',2,'CSE',7000.00,'4NM23CS002',NULL,NULL,'CSE',NULL,NULL),(3,'Priya Nair','Female',1,'ECE',6000.00,'4NM23EC003',NULL,NULL,'ECE',NULL,NULL),(4,'Sneha Rao','Female',3,'ISE',9000.00,'4NM23IS004',NULL,NULL,'ISE',NULL,NULL),(5,'Kiran Kumar','Male',1,'MECH',5000.00,'4NM23ME005',NULL,NULL,'MECH',NULL,NULL),(6,'shravan','Female',2,'MEC',50000.00,NULL,NULL,NULL,'MEC',NULL,NULL),(7,'pavan kuamr','Female',2,'ISE',30000.00,NULL,NULL,NULL,'ISE',NULL,NULL),(8,'pavan l poojary','Male',4,'ISE',3000.00,'NNM24IS149','',4,'ISE','6362348710','pavan'),(11,'pavan l poojary','Male',2,'ISE',3000.00,'NNM24IS150','',4,'ISE','6362348710','123'),(12,'posal','Female',3,'CHEM',10000.00,'NNM25IS508','',2,'CHEM','632574125','123'),(13,'priya','Male',4,'ISE',8000.00,'NNM24IS160',NULL,7,'ISE',NULL,NULL),(14,'azmal','Male',5,'EEE',5000.00,'NNM24IS161',NULL,7,'EEE',NULL,NULL),(15,'pratham nayak','Male',4,'MECH',7000.00,'NNM24IA163','',5,'MECH','9663827927','123'),(16,'SURESH','Male',3,'CSE',5000.00,'NNM24IS148','',4,'CSE','123456789','123'),(17,'pinto','Male',2,'CSE',5000.00,'NNM24IS169','',3,'CSE','9632593724','123');
...
CREATE TABLE `waitlist` (
  ...
  `status` enum('Waiting','Allocated') DEFAULT 'Waiting',
...
INSERT INTO `waitlist` VALUES (1,17,'2026-04-23 09:54:56','Waiting');
...
-- Dump completed on 2026-04-24  7:32:48
